package object SubsecuenciaMasLarga {
  ...
  type Subsecuencia = Seq[Int]
    ...
    /**
     * Devuelve la subsecuencia incremental más larga de s
     * Utiliza subSecuenciasInc para obtener todas las subsecuencias incrementales
     * y luego selecciona la de mayor longitud
     *
     * @param s Secuencia de enteros
     * @return La subsecuencia incremental de tamaño máximo
     */
